...
\begin{tcbposter}[
    poster = {
        ...
        width = \textwidth, 
        spacing=2em},
    boxes = {colback=white, boxrule=1mm, fonttitle=\fontsize{14}{16}\boldfont,
             colframe=blue}
    ]
    \posterbox[adjusted title=Information sur la station de suivi]
        ...
        \begin{tabularx}{\textwidth}{
            ...
            l
            @{}}
        Municipalité (code) : \municipality{} (67020) & Longitude : -70.3709 \\ 
        MRC : Les Etchemins & Longitude : 46.40819 \\  
        Région : Chaudière-Appalaches & NAD : 83\\
        ...
        \multicolumn{2}{@{}X@{}}{Lacunes dans les données : aucune}\\
        \end{tabularx}}
        }
...
\begin{tcbposter}[
    ...
    \posterbox[adjusted title=Schéma de la station de suivi,
        ...
        {
        \includegraphics[trim={1.7cm 3.5cm 2.75cm 5.25cm}, clip, height=0.95\textheight]
        {./schema_puits_rsesq/schema_puits_03030008.pdf}
        }
\end{tcbposter}
